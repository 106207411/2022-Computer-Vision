...
def get_cifar10_train_val_set(root, ratio=0.9, cv=0):
    ...
    train_set, val_set = cifar10_dataset(images=train_image, labels=train_label,transform=train_transform, type='train'), \
                        cifar10_dataset(images=val_image, labels=val_label,transform=val_transform, type='val')
...
class cifar10_dataset(Dataset):
    def __init__(self,images , labels=None , transform=None, prefix='./p2_data/train', type='train'):
