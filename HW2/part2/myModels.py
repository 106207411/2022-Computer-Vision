...
class residual_block(nn.Module):
    def __init__(self, in_channels):
        ...
        self.conv = nn.Sequential(nn.Conv2d(in_channels=in_channels, out_channels=in_channels, kernel_size=3, padding=1),
...
class conv(nn.Module):
    def __init__(self, in_ch=64, out_ch=64):
        ...
        self.conv = nn.Sequential(nn.Conv2d(in_ch, out_ch, kernel_size=3, stride=1, padding=1),
...
class myResnet(nn.Module):
    def __init__(self, in_channels=3, num_out=10):
        ...
        self.res_block2 = residual_block(64)
